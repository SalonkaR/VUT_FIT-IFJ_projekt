...
#define SYN_OK 				    	0 // Syntax je v poriadku
...
#define SEM_ERR_NO_PARAMS			6 // Semanticka chyba - Zly pocet navratoch/ vstupnych hodnot
#define SEM_ERR_OTHER               7 // Ostatne semanticke chyby
